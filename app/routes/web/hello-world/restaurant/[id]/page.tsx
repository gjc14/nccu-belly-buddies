...
const mockRooms = [
  {
    ...
    restaurantInfo: {
      description: "Authentic Japanese sushi restaurant with fresh fish delivered daily.",
  ...
  },
  {
    ...
    restaurantInfo: {
      description: "Family-owned Italian restaurant specializing in handmade pasta and traditional recipes.",
  ...
  },
  {
    ...
    restaurantInfo: {
      description: "Authentic Mexican taqueria with handmade tortillas and traditional fillings.",
            ...
            <Card>
              <CardHeader>
                <div className="flex justify-between items-start">
                  <div>
                    <CardTitle className="text-2xl">{room.restaurantName}</CardTitle>
                    <CardDescription className="text-base mt-1">
                      {room.restaurantInfo.cuisine} • {room.restaurantInfo.priceRange}
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-6">
                <div>
                  ...
                  <p className="text-muted-foreground">{room.restaurantInfo.description}</p>
                </div>
                ...
                <div className="flex flex-wrap gap-3">
                  <Button variant="outline" size="sm" asChild>
                    <a href={room.restaurantInfo.website} target="_blank" rel="noopener noreferrer">
                      Visit Website
                      <ExternalLink className="ml-1 h-3 w-3" />
                    </a>
                  </Button>
                  <Button variant="outline" size="sm" asChild>
                    <a href={room.restaurantInfo.menuLink} target="_blank" rel="noopener noreferrer">
                      View Menu
                      <ExternalLink className="ml-1 h-3 w-3" />
                    </a>
                  </Button>
          ...
          <div>
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="pt-2">
                  <Button className="w-full" onClick={handleJoinRoom} disabled={room.currentPeople >= room.maxPeople}>
                    Join Meetup
                  </Button>
                </div>
              </CardContent>
