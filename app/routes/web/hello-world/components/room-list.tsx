...
export function RoomList() {
  ...
  const handleJoinRoom = (e:any, room:any) => {
    ...
    setRooms(rooms.map((r) => (r.id === room.id ? { ...r, currentPeople: r.currentPeople + 1 } : r)))
  ...
  const handleReviewsClick = (e:any, roomId:string) => {
    ...
    toast(
       "Reviews Restaurant reviews feature coming soon!",
    )
  }
      ...
      {rooms.map((room) => (
        ...
        >
          ...
          <CardFooter className="flex justify-between items-center pt-3 border-t">
            ...
            <Button onClick={(e) => handleJoinRoom(e, room)} disabled={room.currentPeople >= room.maxPeople}>
              Join
            </Button>
          </CardFooter>
        </Card>
