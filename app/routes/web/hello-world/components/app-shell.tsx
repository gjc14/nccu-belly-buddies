    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <aside className="hidden md:flex w-52 flex-col border-r bg-muted/40 p-4">
        ...
        <nav className="space-y-2 mb-6">
          <Link to="/" className="flex items-center gap-2 text-sm font-medium px-3 py-2 rounded-md hover:bg-muted">
            Find Rooms
          </Link>
          <Link
            to="/my-rooms"
        ...
        <div className="mt-auto">
          <Button onClick={() => setIsCreateRoomOpen(true)} className="w-full text-sm py-1 px-2 h-auto">
